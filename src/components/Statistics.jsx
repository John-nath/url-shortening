        ...
        <div className='flex flex-col items-center py-10 sm:justify-center sm:gap-4 sm:flex-row sm:w-full'>
          <div className='flex  justify-center flex-col w-[75%] sm:w-1/4 h-72'>
            ...
            <div className='sm:flex  sm:justify-end'>
              <hr className='1-8 sm:w-32 h-[4px]  sm:h-[5px] font-black align-self-end rotate-90 sm:rotate-0 sm:translate-y-[-90px] sm:translate-x-32 bg-cyan-300 '/>
            </div>
          </div>
          <div className='flex flex-col mt-[-20px] w-[75%] sm:justify-center sm:w-1/4 h-72 translate-y-10'>
            ...
            <div className='sm:flex sm:justify-end'>
            <hr className='1-8 sm:w-32 h-[4px]  sm:h-[5px] font-black align-self-end rotate-90 sm:rotate-0 sm:translate-y-[-130px] sm:translate-x-32 bg-cyan-300 '/>
            </div>
          </div>
          <div className='flex flex-col mt-[-20px] justify-center w-[75%] sm:w-1/4  h-72 translate-y-20'>
            <div className=' self-center bg-blue-950 p-5 w-20 rounded-full z-20  translate-y-[50%] sm:self-start sm:ml-4'><img  className=' w-fit' src={assets.fully_customizable_icon} alt="" /></div>
                <div className='bg-white py-16 px-4 h-full rounded-md text-center'>
